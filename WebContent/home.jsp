            ...
            <div class="assignment-list">
              ...
              <div class="col-sm-2">
                <div class="card assignment-item" style="width: 18rem;min-height: 180px;">
                  <div class="card-body">
                    <a href="${pageContext.request.contextPath}/EmailListForm" class="card-title">Email List</a>
                    <p class="card-text">
                      Bài tập Email List
                    </p>
                    <p class="card-text">
              ...
              <div class="col-sm-2">
                <div class="card assignment-item" style="width: 18rem; min-height: 180px;">
                  <div class="card-body">
                    <a href="${pageContext.request.contextPath}/SurveyForm" class="card-title">Survey</a>
                    <p class="card-text">
                      Bài tập Survey
                    </p>
                    <p class="card-text">
